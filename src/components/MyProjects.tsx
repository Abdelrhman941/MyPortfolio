  ...
  const projects: ThreeDCarouselItem[] = [
    {
      ...
      bgGradient: "from-[#ff8c00]/20 via-[#ff6b00]/10 to-[#ff8c00]/20",
    },
    {
      id: 2,
      ...
      bgGradient: "from-[#ff3d00]/20 via-[#ff6b00]/10 to-[#ff007f]/20",
    },
    {
      id: 3,
      ...
      bgGradient: "from-[#0d0d0d]/20 via-[#131313]/10 to-[#1a1a1a]/20",
    },
    {
      id: 4,
      ...
      bgGradient: "from-[#ffb700]/20 via-[#ffc933]/10 to-[#ffb700]/20",
    },
    {
      id: 5,
      ...
      bgGradient: "from-[#ff007f]/20 via-[#ff3d00]/10 to-[#ff8c00]/20",
    },
  ];

  return (
    <section id="projects" className="w-full bg-[#0d0d0d] py-24">
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        {items.map((project, index) => (
          ...
          >
            <div className="bg-[#131313] dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-800/50 hover:border-[#ff8c00]/30 transition-all duration-300 min-h-[480px] flex flex-col">
              {/* Top: Image with dynamic gradient background */}
              <div className={`w-full h-[280px] bg-gradient-to-br ${project.bgGradient || 'from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900'} flex items-center justify-center p-0`}>
                <img
                  src={project.imageUrl}
                  alt={project.title}
                  className="w-full h-full object-cover drop-shadow-lg transition-transform duration-500 hover:scale-105"
              ...
              <div className="p-5 flex flex-col justify-between flex-1">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {project.tags.map((tag, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 bg-gradient-to-r from-[#ff8c00]/20 to-[#ff3d00]/20 text-[#ffb700] rounded-full text-xs font-medium border border-[#ff8c00]/30"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className={`flex gap-3 mt-3 ${!project.youtubeUrl ? 'justify-center' : ''}`}>
                  <motion.a
                    ...
                    className={`${project.youtubeUrl ? 'flex-1' : 'w-full max-w-xs'} flex items-center justify-center gap-2 px-4 py-2.5 border-2 border-gray-900 dark:border-gray-100 text-gray-900 dark:text-gray-100 rounded-lg font-medium hover:bg-gray-900 hover:text-white dark:hover:bg-gray-100 dark:hover:text-gray-900`}
                  ...
                  {project.youtubeUrl && (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-[#FF0000] text-white rounded-lg font-medium hover:bg-[#CC0000] hover:shadow-[0_4px_16px_rgba(255,0,0,0.4)]"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        {items.map((_, idx) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-300 ${
              active === idx
              ? "bg-gradient-to-r from-[#ff8c00] to-[#ff3d00] w-8"
              : "bg-gray-600 dark:bg-gray-600 w-2 hover:bg-[#ffb700] dark:hover:bg-[#ffb700]"
            }`}
      ...
      <motion.button
        className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-[#131313] dark:bg-gray-800 rounded-full items-center justify-center text-gray-300 dark:text-gray-300 hover:bg-[#1a1a1a] dark:hover:bg-gray-700 hover:text-[#ffb700] z-30 shadow-lg hover:shadow-[0_0_20px_rgba(255,183,0,0.3)] border border-gray-700/50 dark:border-gray-700"
      ...
      <motion.button
        className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-[#131313] dark:bg-gray-800 rounded-full items-center justify-center text-gray-300 dark:text-gray-300 hover:bg-[#1a1a1a] dark:hover:bg-gray-700 hover:text-[#ffb700] z-30 shadow-lg hover:shadow-[0_0_20px_rgba(255,183,0,0.3)] border border-gray-700/50 dark:border-gray-700"
