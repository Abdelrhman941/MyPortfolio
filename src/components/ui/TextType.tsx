...
declare const gsap: any; // For using gsap from CDN
...
interface TextTypeProps {
  ...
  reverseMode?: boolean;
  [key: string]: any; // for other props passed to the component
}
...
const TextType: React.FC<TextTypeProps> = ({
  ...
  useEffect(() => {
    if (typeof gsap === 'undefined' || !showCursor || !cursorRef.current) return;
